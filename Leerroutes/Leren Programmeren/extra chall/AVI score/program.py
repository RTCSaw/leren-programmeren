...
characterLabel = tk.Label(root, text=f'Karakters:', width=15, bg='black', fg='white') # generate characterLabel
sentencesLabel = tk.Label(root, text=f'Zinnen:', width=15, bg='black', fg='white')    # generate sentencesLabel
wordsLabel = tk.Label(root, text=f'Woorden:', width=15, bg='black', fg='white')       # generate wordsLabel
aviLabel = tk.Label(root, text=f'Avi score:', width=15, bg='black', fg='white')   
